...
const updateAppointmentRequestStatus = (id, status)=>{
    ...
    if (requestIndex > -1) {
        ...
        setStoredData('appointmentRequests', [
            {
...
function PatientAppointments({ onAppointmentRequest }) {
    ...
    function onSubmit(data) {
        if (!user) return;
        const newRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAppointmentRequest"])(data, user.name);
...
_s(PatientAppointments, "tIeOgzSCz1PafZx1fh4Q30kubbE=", false, function() {
    return [
...
function AppointmentsPage() {
    ...
    const [appointmentRequests, setAppointmentRequests] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAppointmentRequests"])());
    const isPatient = user?.role === 'patient';
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppointmentsPage.useEffect": ()=>{
            if (user) {
                const fetchAppointments = {
                    "AppointmentsPage.useEffect.fetchAppointments": ()=>{
                        setAppointments(isPatient ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPatientAppointments"])(user.name) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEmployeeAppointments"])(user.name));
                    }
                }["AppointmentsPage.useEffect.fetchAppointments"];
                fetchAppointments();
                const interval = setInterval(fetchAppointments, 1000); // Poll for changes
                return ({
                    "AppointmentsPage.useEffect": ()=>clearInterval(interval)
                })["AppointmentsPage.useEffect"];
            }
        }
    }["AppointmentsPage.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppointmentsPage.useEffect": ()=>{
            const fetchRequests = {
                "AppointmentsPage.useEffect.fetchRequests": ()=>{
...
_s2(AppointmentsPage, "7phkBUzQYrMZVSh0CnDwgTrBnyQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
_c3 = AppointmentsPage;
var _c, _c1, _c2, _c3;
...
__turbopack_context__.k.register(_c3, "AppointmentsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_b768fe0b._.js.map